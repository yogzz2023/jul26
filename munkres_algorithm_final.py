...
class CVFilter:
    ...
    def update_step(self, Z):
        ...
        print("Updated filter state (Sf):", self.Sf.flatten())  # Print updated state
...
def hungarian_algorithm(cost_matrix):
    # Implementation of the Hungarian Algorithm (Munkres)
    ...
    for group_idx, group in enumerate(measurement_groups):
        ...
        if predicted_states:
            ...
            for pred_idx, meas_idx in indexes:
                ...
                print("Updated filter state (Sf):", kalman_filter.Sf.flatten())
